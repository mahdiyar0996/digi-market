...
# def spam():
#     r = requests.get('http://localhost:8000/users/?email=admin@gmail.com')
#     return r.json()
#
# # s=  "[\n     {\n          \"avatar\": \"users/profile/haking_is_the_new_espionage_YWiz92x.jpg\",\n          \"first_name\": \"admin\",\n          \"last_name\": \"mahdi\",\n          \"user__username\": \"admin\",\n          \"user__email\": \"admin@gmail.com\",\n          \"user__phone_number\": \"09963001880\"\n     }\n]"
# while True:
#     t1 = Thread(target=spam)
#     t2 = Thread(target=spam)
#     t3 = Thread(target=spam)
#     t4 = Thread(target=spam)
#     t5 = Thread(target=spam)
#     t1.start()
#     t2.start()
#     # t3.start()
#     # t4.start()
